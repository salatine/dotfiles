...
--{description="show help", group="awesome"}),
  awful.key({ modkey }, "s", function()
      ...
      hotkeys_popup.widget.new({
        ...
        height = 890,
        font = "Sofia Pro Light 13",
        description_font = "Sofia Pro Light 12"
  ...
  awful.key({ modkey }, "r", function()
      fade_to_random_wallpaper(20, 1 / 60, function(surf)
  ...
  awful.key({}, "Print", function() awful.spawn("flameshot screen -c") end,
    { description = "take a fullscreenshot and copy to clipboard", group = "applications" }),
  -- Standard program
  ...
  awful.key({ modkey }, "c", function() awful.spawn("flameshot gui") end,
    { description = "printscreen flameshot gui", group = "applications" }),
...
function fade_to_random_wallpaper(steps, interval, callback)
  ...
  local old_wp = get_maximized_surface(surface(beautiful.wallpaper), screen_width, screen_height)
  if not old_wp then
    callback(new_wp)
    return
  end
